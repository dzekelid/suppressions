...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/suppressions/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - Get a list of the supported sending methods for a
    correspondence (ie all of the types required by each document in each envelope)
  x-api-slug: apidocumentgenerationpacksupportedsendmethodspackid-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/suppressions/master/_listings/dezrez/apidocumentgenerationpacksupportedsendmethodspackid-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Get a list of the supported sending methods for a
    correspondence (ie all of the types required by each document in each envelope)
  x-api-slug: apidocumentgenerationpacksupportedsendmethodspackid-get
  description: Get a list of the supported sending methods for a correspondence (ie
